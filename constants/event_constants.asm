...
; Pallet Town events
	...
	const_skip 17
	const EVENT_GOT_TOWN_MAP ; 24
	const EVENT_ENTERED_BLUES_HOUSE ; 25
	const EVENT_DAISY_WALKING ; 26
	const_skip 5
	const EVENT_FOLLOWED_OAK_INTO_LAB_2 ; 32
	const EVENT_OAK_ASKED_TO_CHOOSE_MON ; 33
	const EVENT_GOT_STARTER ;34
	const EVENT_BATTLED_RIVAL_IN_OAKS_LAB ; 35
	const EVENT_GOT_POKEBALLS_FROM_OAK ; 36
	const EVENT_GOT_POKEDEX ; 37
	const EVENT_PALLET_AFTER_GETTING_POKEBALLS_2 ; 38
	const EVENT_OAK_APPEARED_IN_PALLET ; 39
...
; Seafoam Islands events
	const_next $9C0
	const EVENT_SEAFOAM2_BOULDER1_DOWN_HOLE ; 0
	const EVENT_SEAFOAM2_BOULDER2_DOWN_HOLE ; 1
	const_skip 6
	const EVENT_SEAFOAM3_BOULDER1_DOWN_HOLE ; 8
	const EVENT_SEAFOAM3_BOULDER2_DOWN_HOLE ; 9
	const_skip 6
	const EVENT_SEAFOAM4_BOULDER1_DOWN_HOLE ; 16 ($9D0)
	const EVENT_SEAFOAM4_BOULDER2_DOWN_HOLE ; 17 ($9D1)
	const_skip 8
	const EVENT_BEAT_ARTICUNO ; 26 ($9DA)

; Pallet Lake House events
	const_next $9DB
	const_skip
	const EVENT_BEAT_PALLET_LAKE_HOUSE_TRAINER_0
